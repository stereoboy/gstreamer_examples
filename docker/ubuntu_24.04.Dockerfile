...
RUN apt-get install -y libgstreamer-plugins-bad1.0-dev libsoup2.4-dev libjson-glib-dev # for sendonly example
#RUN apt-get install -y libgstreamer-plugins-bad1.0-dev libsoup-3.0-dev libjson-glib-dev # for sendonly example
